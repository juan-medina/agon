...
& psql -U postgres -c '\q' 2>&1 | Out-Null
$ErrorActionPreference = 'Stop'
...
Set-EnvLine $envFile 'DATABASE_URL'       "postgres://yurnik_api:$apiPassword@localhost:5432/yurnik"
Set-EnvLine $envFile 'DATABASE_ADMIN_URL' "postgres://yurnik_admin:$adminPassword@localhost:5432/yurnik"
